...
public class jwnlOps {
    ...
    public boolean assetIsRel(String head,String tail) throws FileNotFoundException, JWNLException{
    ...
    public boolean assetPartOfRel(String head,String tail) throws FileNotFoundException, JWNLException{
        Boolean partConf=false;
        String morHead=getMorphologicalRoot(head);
        String morTail=getMorphologicalRoot(tail);
        Set<String> partSet=getMeronym(morHead);
        String morTailMod=morTail.replaceAll(" ", "_");
     
        if(partSet.contains(morTailMod)){
            partConf=true;
        }
        return partConf;
    }
